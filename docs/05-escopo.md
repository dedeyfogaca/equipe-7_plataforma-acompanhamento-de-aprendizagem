...
- Cadastro, edição e exclusão de atividades com título, descrição, disciplina, conteúdo, prazo, prioridade, status e responsável
- Listagem de atividades com busca por texto, filtros por status, responsável e prazo, e ordenação
...
| **Equipe** | Três integrantes, todos conciliando o projeto com as demais disciplinas do curso |
| **Tecnologia** | Interface em React 18 com Vite |
| **Persistência** | Nesta versão os dados são armazenados no navegador do usuário, o que restringe o acesso ao dispositivo utilizado e impede o compartilhamento automático entre integrantes |
