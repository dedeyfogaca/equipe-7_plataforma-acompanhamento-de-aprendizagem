...
| **RF03** | O sistema deve permitir cadastrar, editar e excluir atividades, informando título, descrição, disciplina, conteúdo, prazo, prioridade, status e responsável. | Alta | RF01, RF02 |
| **RF04** | O sistema deve exibir a lista de atividades do grupo com busca por texto, filtros por status, responsável e prazo, e ordenação. | Alta | RF03 |
...
| **RF10** | O sistema deve calcular e exibir o percentual de progresso de cada conteúdo a partir das atividades concluídas. | Alta | RF03 |
